...
public class EditorDeBaralhoIdiomasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editor_de_baralho_idiomas);
    }
    ...
    protected void onStart() {
        ...
        recyclerView = findViewById(R.id.edbci_lista_baralho);
    ...
    public void edbciExcluir(View view){
        //instanciar alertdialog
        AlertDialog.Builder dialog = new AlertDialog.Builder(this);
        //configurar tipo mensagem
        dialog.setTitle(R.string.edb_dia_titulo);
